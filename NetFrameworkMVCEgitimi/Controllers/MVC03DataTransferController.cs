...
namespace NetFrameworkMVCEgitimi.Controllers
{
    public class MVC03DataTransferController : Controller
    {
        ...
        {
            // 3 farklı yöntemle controllerden view a basit veriler gönderebiliriz

            // 1- ViewBag : Tek kullanımlık ömrü vardır
            ViewBag.UrunKategorisi = "Bilgisayar"; // Burada ViewBag ismi standart olarak
            // yazılır sonrasında . deyip dilediğimiz değişken adını yazabiliriz.
            // 2- 
        ...
        [HttpGet] // attribute : Dikkat! bir metodun üzerinde attribute yoksa varsayılan tür gettir !!!
        public ActionResult Search(string txtAra)
        {
            ViewBag.GetVerisi = txtAra; // querystring deki txtAra yapısının değeri getir.
            return View();
        }
        [HttpPost] // attribute 
        public ActionResult Index(string txtUrunAdi, string ddlKategori, bool cbOnay, string rbOnay, FormCollection formCollection)
        {
            ...
            ViewBag.Baslik3 = "3. Request Form ile yakalama";
